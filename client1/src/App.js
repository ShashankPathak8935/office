    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route path="/ourproducts" element={<PrivateRoute requiredRole="admin"><Layout><Ourproducts /></Layout></PrivateRoute>} />
          ...
          <Route path="/purchase-history" element={<PrivateRoute requiredRole="user"><PurchaseHistory /></PrivateRoute>} />
           <Route path="/final-payment" element={<PrivateRoute requiredRole="user"><FinalPayment /></PrivateRoute>} /> 
